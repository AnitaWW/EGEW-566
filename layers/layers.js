...
jsonSource_village_3.addFeatures(features_village_3);cluster_village_3 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_village_3
});
var lyr_village_3 = new ol.layer.Vector({
                declutter: true,
                source:cluster_village_3, 
...
lyr_Positron_0.setVisible(true);lyr_amphoe_1.setVisible(true);lyr_stream_2.setVisible(true);lyr_village_3.setVisible(true);lyr_transportation_4.setVisible(true);
var layersList = [lyr_Positron_0,lyr_amphoe_1,lyr_stream_2,lyr_village_3,lyr_transportation_4];
...
lyr_village_3.set('fieldAliases', {'NRD_CODE': 'NRD_CODE', 'VILL_CODE': 'VILL_CODE', 'VILL_NAM_T': 'VILL_NAM_T', 'PROV_CODE': 'PROV_CODE', 'AMP_CODE': 'AMP_CODE', 'TAM_CODE': 'TAM_CODE', });
...
lyr_village_3.set('fieldImages', {'NRD_CODE': '', 'VILL_CODE': '', 'VILL_NAM_T': '', 'PROV_CODE': '', 'AMP_CODE': '', 'TAM_CODE': '', });
lyr_transportation_4.set('fieldImages', {'LENGTH': '', 'TRANS_TYP': '', 'TYP_T': '', 'NAME_T': '', 'NAME_E': '', 'TranNo': '', 'TranTyp_n': '', });
...
lyr_village_3.set('fieldLabels', {'NRD_CODE': 'no label', 'VILL_CODE': 'no label', 'VILL_NAM_T': 'no label', 'PROV_CODE': 'no label', 'AMP_CODE': 'no label', 'TAM_CODE': 'no label', });
...
lyr_transportation_4.on('precompose', function(evt) {
